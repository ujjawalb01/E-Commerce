...
function MyOrders() {
    ...
    setTimeout(() => {
      const mockOrder = [
        ...
        },
        {
          _id: "1333",
          createAt: new Date(),
          shippingAddress: { city: "NeyYork", country: "USA" },
          orderItems: [
            {
              name: "Product 2",
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      <h2 className="text-xl sm:text-2x font-bold mb-6">My Order</h2>
      <div className="relative shadow-md sm:rounded-lg overflow-hiddedn">
